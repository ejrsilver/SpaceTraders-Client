...
let BaseURL = "https://api.spacetraders.io/v2"
let KeychainKey = "spacetraders-bearer-token"
...
class StaticResource<S: Encodable, R: Decodable>: ObservableObject, Creatable {
  ...
  func send(forItem: S) async throws {
    ...
    guard httpResponse.statusCode == 200 || httpResponse.statusCode == 201 || httpResponse.statusCode == 206 else {
